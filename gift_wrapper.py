...
ui = {}
ui["TargetObject"] = "Cube"
ui["DistForSearch"] = 4.0
...
def main():
    ...
    print("-----Start-----")
    SkinVerts(obj, verts) # main function of skinning
    print("-----Log-----")
    print(gbLog)
...
def SkinVerts(obj, verts):
    ...
    # Get mesh instance
    try:
        object = obj#bpy.data.objects[point_cloud]
        lcMesh = object.data
    except:
    ...
    print(verts)
    FaceCreater.add_by_vertices_raw(lcMesh, verts)
